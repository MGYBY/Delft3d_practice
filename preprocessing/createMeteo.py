...
for i in iter_var:
    ...
    outfile.write('quantity2 = '+quantity2+'\n')
    outfile.write('quantity3 = '+quantity3+'\n')
    outfile.write('unit1 = '+unit1+'\n')
    outfile.write('unit2 = '+unit2+'\n')
    outfile.write('unit3 = '+unit3+'\n')
    time1 = 0

    # WRITE DATA IN FILE
    # for t in range(int(input('time to write '+i+'(time size ' + str(vars['time'].shape) + '): '))):
    for t in range(int(input('time to write '+i+'(time size ' + str(vars['valid_time'].shape) + '): '))):
        ...
        for n in range(int(vars[i].shape[1])):
            for m in range(int(vars[i].shape[2])):
                if i == 't2m':
                    ...
                    outfile.write(str(nc_data[var_inter_n['u10']][t, n, m])+' ')
            outfile.write('\n')
        ...
        for n in range(int(vars[i].shape[1])):
            for m in range(int(vars[i].shape[2])):
                if i == 't2m':
                    ...
                    outfile.write(str(nc_data[var_inter_n['v10']][t, n, m])+' ')
        ...
        for n in range(int(vars[i].shape[1])):
            for m in range(int(vars[i].shape[2])):
                if i == 't2m':
                    ...
                    outfile.write(str(nc_data[var_inter_n['sp']][t, n, m])+' ')
            outfile.write('\n')
